...
gameTitle: 'Словоход',
      ...
      themeShop: 'Тема',
      themeShopTitle: 'Тема «Мятная бумага»',
      themeBuyHint: 'Разблокирует альтернативную окраску плиток',
      themeBuy: 'Купить',
      themeApply: 'Применить',
      themeRevert: 'Вернуть обычную',
      themeClose: 'Закрыть',
      themeOwned: 'Уже куплена',
      themePending: 'Секунду…',
      themeUnavailable: 'Покупка недоступна, попробуйте позже',
    },
    en: {
      loading: 'Loading…',
gameTitle: 'Словоход',
      ...
      newRecord: 'New best!',
      themeShop: 'Theme',
      themeShopTitle: 'Theme: "Mint Paper"',
      themeBuyHint: 'Unlocks an alternate tile color scheme',
      themeBuy: 'Buy',
      themeApply: 'Apply',
      themeRevert: 'Revert to default',
      themeClose: 'Close',
      themeOwned: 'Already owned',
      themePending: 'One sec…',
      themeUnavailable: 'Purchase unavailable, try again later',
    },
  };
