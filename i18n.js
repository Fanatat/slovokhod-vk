...
gameTitle: 'Словоход',
      ...
      store: 'Магазин',
      themeMint: 'Мятная бумага',
      themeDefault: 'Тёплая бумага',
      buy: 'Купить',
      buying: 'Покупаем…',
      active: 'Активна',
      activate: 'Выбрать',
      storeErrorGeneric: 'Не удалось завершить покупку. Попробуйте позже.',
      storeErrorServer: 'Сервер проверки покупок недоступен. Попробуйте позже.',
    },
    en: {
      loading: 'Loading…',
gameTitle: 'Словоход',
      ...
      newRecord: 'New best!',
      store: 'Store',
      themeMint: 'Mint Paper',
      themeDefault: 'Warm Paper',
      buy: 'Buy',
      buying: 'Purchasing…',
      active: 'Active',
      activate: 'Select',
      storeErrorGeneric: 'Could not complete the purchase. Please try again later.',
      storeErrorServer: 'The purchase verification server is unavailable. Please try again later.',
    },
  };
